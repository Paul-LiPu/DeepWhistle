function [Signal, power_dB, snr_power_dB, Indices, dft, clickP] = ...
    dtProcessBlock_lipu(handle, header, channel, ...
...
Signal = ioReadWav_lipu(handle, header, start, stop, ...
    'Units', 's', 'Channels', channel);
...
[power_dB, snr_power_dB, Indices, dft, clickP] = dtSpecAnal_lipu(Signal, header.fs, ...
