...
train_samples = 0
test_samples = 0
train_dataset = m_dataset.Dataset_lmdb_manual_data2_recall3(negative_file=negative_data_file, positive_file=positive_data_file, max_readers=config.workers)
...
while True:
    ...
    train_dataset.recall_list = recall_list
    logging.info(
